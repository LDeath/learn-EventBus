...
- (void)layoutSubviews {
    ...
    //	CGSize labelSize = [label.text sizeWithFont:label.font];// iOS7 开始废弃方法
    CGSize labelSize = [label.text sizeWithAttributes:@{NSFontAttributeName:label.font}];// 新的替换方法
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];// 该方法已废弃
    NSMutableParagraphStyle *paragraphStytle = [[NSMutableParagraphStyle alloc] init];
    paragraphStytle.lineBreakMode = NSLineBreakByWordWrapping;
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font, NSParagraphStyleAttributeName:paragraphStytle.copy} context:nil].size;// 新的替换方法
